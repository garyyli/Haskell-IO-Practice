...
main = do
    ...
    stringText <- getLine
    putStrLn $ "You entered "++ show stringText ++ "."
    putStrLn "Now jumble it:"
    putStrLn $ reverse stringText
    putStrLn $ unwords $ reverse $ words stringText
    putStrLn $ unwords $ reverse $ words $ reverse stringText
